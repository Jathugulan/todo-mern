import { CheckSquare, LogOut, Plus, Search, User, X } from 'lucide-react';
          ...
          <div className="flex-1 max-w-md hidden md:block">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-9 py-2 text-sm bg-slate-900/80 text-slate-200 placeholder-slate-400 rounded-xl border border-slate-700/60 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/50 transition-all"
              />
              {searchQuery && (
                <button
