...
import { CheckSquare, Eye, EyeOff, Lock, Mail, ArrowRight, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 relative overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Sign in to manage your tasks effectively</p>
        </div>
