...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-slate-950 text-slate-100 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-indigo-600/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-purple-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="glass-panel w-full max-w-sm sm:max-w-md p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-slate-100">Create an Account</h2>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">Get started with your task dashboard</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="glass-input w-full pl-10 pr-4 py-2.5 sm:py-2.5 rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="glass-input w-full pl-10 pr-10 py-2.5 sm:py-2.5 rounded-xl text-slate-100 placeholder-slate-500 text-sm focus:outline-none transition-all"
              />
              <button
                type="button"
